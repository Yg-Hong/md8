package com.ms8.md.bigdata.global.exception;
...
public class GlobalExceptionHandler {
    ...
    protected final ResponseEntity<ErrorResponse> handleMethodArgumentTypeMismatchException(Exception ex) {
        log.error("MethodArgumentTypeMismatchException", ex);
        final ErrorResponse response = ErrorResponse.of(ErrorCode.BAD_REQUEST_ERROR, "잘못된 요청입니다.");
        return new ResponseEntity<>(response, HttpStatus.BAD_REQUEST);
    }
