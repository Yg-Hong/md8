package com.ms8.md.sns.global.common.code;
...
public enum ErrorCode {
    ...
    UNSUPPORTED_MEDIA_TYPE_ERROR(HttpStatus.INTERNAL_SERVER_ERROR.value(), "G888", "지원하지 않는 Content Type입니다"),
    ...
    INVALID_USER_INFO(401, "9001", "유효하지 않은 유저 입니다."),
    DATA_NOT_EXIST(400, "2001", "데이터가 존재하지 않습니다"),
    DATA_ALREADY_EXIST(400, "2002", "이미 해당 데이터가 존재합니다."),

    FILE_NOT_EXIST(400, "3001", "파일이 존재하지 않습니다.")
